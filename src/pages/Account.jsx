            ...
            <div className="col-xl-3 col-lg-4">
              <div className="account-sidebar">
                ...
                >
                  ...
                  >
                    <span className="icon">
                      <i className="fa-duotone fa-objects-column"></i>
                    </span>{" "}
                  ...
                  >
                    <span className="icon">
                      <i className="fa-duotone fa-user-vneck"></i>
                    </span>{" "}
                        ...
                        <div className="top">
                          ...
                          <div className="tags">
                            ...
                            <span className="tag tag-down">
                              <i className="fa-light fa-arrow-down-left"></i>{" "}
                              $700.99
                            </span>
                          </div>
                        </div>
                  ...
                  <div className="profile-panel">
                    ...
                    <form>
                      <div className="row g-lg-4 g-3">
                        ...
                        <div className="col-sm-6">
                          <select name="country" className="select wide">
          ...
          <div className="modal-content">
            ...
            <div className="modal-footer">
              <button type="button" className="def-btn">
                Print <i className="fa-regular fa-print"></i>
              </button>
              <button type="button" className="def-btn">
                Download <i className="fa-regular fa-download"></i>
              </button>
            </div>
          </div>
        </div>
