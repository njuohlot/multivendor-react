                          ...
                          {cart.map((item, key) => (
                            <>
                              <tr key={item.id}>
                                ...
                                <td>
                                  <span className="price-txt">
                                    $<span className="total-price">460</span>
                                  </span>
                                </td>
                                <td>
                          ...
                          <div className="shipping-mode">
                            ...
                            <div className="form-check">
                              ...
                              <label
                                ...
                                for="homeDelivery"
                              >
                                Delivery at home (2 - 4 day) - $2.00{" "}
                                <span>
                                  1206 Sussex TX - 76541
                                </span>
                              </label>
                            </div>
                          </div>
                          ...
                          <div className="calculate-area">
                            <ul>
                              <li>
                                Sub Total{" "}
                                <span className="price-txt">
                                  $<span className="sub-total">1026</span>
                                </span>
                              </li>
                              <li>
                                Shipping{" "}
                  ...
                  <div className="row">
                    ...
                    <div className="col-xl-4 col-lg-5 col-md-6">
                      <div className="payment-method">
                        ...
                        >
                          Place Order{" "}
                          <i className="fa-light fa-truck-arrow-right"></i>
                        </button>
                      </div>
                    </div>
                  </div>
