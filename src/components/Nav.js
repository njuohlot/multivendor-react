    ...
    <div>
                ...
                <li key={item.id}>
                  <a href={`/product/details/${item.id}`}>
                    ...
                    <div className="part-txt">
                      ...
                      <span>
                        1 <i className="fa-regular fa-xmark"></i> ${item.newPrice}
                      </span>
                    </div>
                  </a>
      ...
      <div className="header-cart-wrap" id="headerWishWrap">
        <div className="cart-list">
          ...
          <div className="btn-box">
            <a href="/whishlist" className="def-btn">
              View Wish List
            </a>
          </div>
        </div>
              ...
              <div className="col-xxl-6 col-xl-7 col-lg-7">
                <ul className="top-header-link d-lg-flex d-none">
                  ...
                  <li>
                    ...
                    <a href="tel:+237659107885"> +237659107885</a>
                  </li>
                  <li>
                ...
                <ul className="bottom-header-right d-flex align-items-center justify-content-end">
                  <li className="live-chat d-xl-flex d-none align-items-center">
                    ...
                    <div className="txt">
                      ...
                      <a className="d-block" href="tel:+237659107885">
                        +237659107885
                      </a>
                    </div>
                  </li>
            ...
            <div className="row align-items-center">
              <div className="col-xxl-3 col-xl-3 col-lg-4">
                <div className="all-department">
                  ...
                  <div className="banner" id="departments">
                      ...
                      <nav id="revel-mobile-menu" className="revel-mobile-menu">
                        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
                          <li className="nav-item dropdown">
                            <a className="nav-link" href="/" id="homeDropdown">
                              Home
                            </a>
                          </li>
